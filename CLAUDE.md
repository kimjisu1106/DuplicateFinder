...
**실행:** `python main.py`
**최초 구현 완료:** 2026-03-22
**마지막 업데이트:** 2026-03-22 (영상 파일 지원, 이미지/영상 검색 대상 선택 UI)
...
- **이미지만 선택 시에만 활성화** — 영상 포함 시 자동 비활성화
...
3. `similar=True`인 경우만: MD5가 다른 파일들에 대해 pHash 계산 (50→100%)
